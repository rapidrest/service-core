...
export enum ApiErrors {
    ...
    SEARCH_UNKNOWN_OPERATOR = "api-016",
    SEARCH_INVALID_OPERAND_TYPE = "api-017",
    SEARCH_INVALID_SORT_FIELD = "api-018",
    SEARCH_QUERY_TOO_COMPLEX = "api-019",
    SEARCH_OPERATOR_NOT_SUPPORTED = "api-020",
    BULK_CREATE_FAILURE = "api-021",
    BULK_UPDATE_FAILURE = "api-022",
    SEARCH_SCOPED_FIELD = "api-023",
...
export enum ApiErrorMessages {
    ...
    SEARCH_UNKNOWN_OPERATOR = "Unknown search operator '{{operator}}'. Use eq() to search for a literal value shaped like an operator call.",
    SEARCH_INVALID_OPERAND_TYPE = "Invalid value '{{value}}' for field '{{field}}'. Expected a {{type}}.",
    SEARCH_INVALID_SORT_FIELD = "Cannot sort by unknown field '{{field}}'.",
    SEARCH_QUERY_TOO_COMPLEX = "The search query is too deeply nested or has too many conditions.",
    SEARCH_OPERATOR_NOT_SUPPORTED = "The '{{operator}}' operator is not supported by the configured datasource.",
    BULK_CREATE_FAILURE = "Failed to create one or more objects.",
    BULK_UPDATE_FAILURE = "Failed to update one or more objects.",
    SEARCH_SCOPED_FIELD = "Cannot filter, sort or count by scoped field '{{field}}'.",
